...
if sys.argv[1] == "stop":
    ...
    for module in secmon_all_modules:
        command = f'docker stop $(docker ps -a | grep secmon-{module} | cut -d " " -f 1)'
        print(command)
        os.system(command)
...
if sys.argv[1] == "start":
    ...
    for module in secmon_all_modules:
        command = f'docker start $(docker ps -a | grep secmon-{module} | cut -d " " -f 1)'
        os.system(command)
...
if sys.argv[1] == "restart":
    ...
    for module in secmon_all_modules:
        ...
        print(command)
        os.system(command)
        command = f'docker rm $(docker ps -a | grep secmon-{module} | cut -d " " -f 1)'
        print(command)
        os.system(command)
