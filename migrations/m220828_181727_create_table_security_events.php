...
class m220828_181727_create_table_security_events extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%security_events}}', [
          ...
          'device_customfloating_point1' => $this->double(),
          'device_customfloating_point1_label' => $this->string(1023),
          'device_customfloating_point2' => $this->double(),
          'device_customfloating_point2_label' => $this->string(1023),
          'device_customfloating_point3' => $this->double(),
          'device_customfloating_point3_label' => $this->string(1023),
          'device_customfloating_point4' => $this->double(),
          'device_customfloating_point4_label' => $this->string(1023),
