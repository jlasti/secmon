...
<ul class="collapsible">
    <li>
      <div class="collapsible-header light-blue accent-4" style="font-size:20px; color: white;"><i class="material-icons">network_wifi</i>Source IP information: <?= $model->source_address?>:<?= $model->source_port ?></div>
  ...
  <ul class="collapsible">
    <li>
      <div class="collapsible-header light-blue accent-4" style="font-size:20px; color: white;"><i class="material-icons">network_wifi</i>Destination IP information: <?= $model->destination_address?>:<?= $model->destination_port?></div>
      <div class="collapsible-body">
        <?= DetailView::widget([
          'model' => $model,
          'attributes' => [
  ...
  <ul class="collapsible">
    <li>
      <div class="collapsible-header light-blue accent-4" style="font-size:20px; color: white;"><i class="material-icons">network_wifi</i>Custom Device IPv6 Address Fields</div>
      <div class="collapsible-body"><?= DetailView::widget([
        'model' => $model,
        'attributes' => [
  ...
  <ul class="collapsible">
    <li>
      <div class="collapsible-header light-blue accent-4" style="font-size:20px; color: white;"><i class="material-icons">pin</i>Custom Device Number Fields</div>
      <div class="collapsible-body"><?= DetailView::widget([
        'model' => $model,
        'attributes' => [
  ...
  <ul class="collapsible">
    <li>
      <div class="collapsible-header light-blue accent-4" style="font-size:20px; color: white;"><i class="material-icons">text_fields</i>Custom Device String Fields</div>
      <div class="collapsible-body"><?= DetailView::widget([
        'model' => $model,
        'attributes' => [
  ...
  <ul class="collapsible">
    <li>
      <div class="collapsible-header light-blue accent-4" style="font-size:20px; color: white;"><i class="material-icons">calendar_month</i>Device Date Fields</div>
      <div class="collapsible-body"><?= DetailView::widget([
        'model' => $model,
        'attributes' => [
            'start_time',
