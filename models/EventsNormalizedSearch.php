...
class EventsNormalizedSearch extends EventsNormalized
{
    ...
    public function rules()
    {
        return [
            ...
            [['datetime', 'host', 'cef_version', 'cef_vendor', 'cef_dev_prod', 'cef_dev_version', 'cef_name', 'src_ip', 'dst_ip', 'protocol', 'src_mac', 'dst_mac', 'extensions', 'raw', 'src_country', 'dst_country', 'src_city', 'dst_city', 'src_latitude', 'dst_latitude', 'src_longitude', 'dst_longitude', 'request_url', 'request_client_application'], 'safe'],
        ];
    }
