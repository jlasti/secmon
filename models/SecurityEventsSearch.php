...
class SecurityEventsSearch extends SecurityEvents
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'device_customfloating_point1' => $this->device_customfloating_point1,
            'device_customfloating_point2' => $this->device_customfloating_point2,
            'device_customfloating_point3' => $this->device_customfloating_point3,
            'device_customfloating_point4' => $this->device_customfloating_point4,
        ...
        $query->andFilterWhere(['ilike', 'cef_version', $this->cef_version])
            ...
            ->andFilterWhere(['ilike', 'device_customfloating_point1_label', $this->device_customfloating_point1_label])
            ->andFilterWhere(['ilike', 'device_customfloating_point2_label', $this->device_customfloating_point2_label])
            ->andFilterWhere(['ilike', 'device_customfloating_point3_label', $this->device_customfloating_point3_label])
            ->andFilterWhere(['ilike', 'device_customfloating_point4_label', $this->device_customfloating_point4_label])
