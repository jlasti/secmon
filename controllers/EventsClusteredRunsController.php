...
class EventsClusteredRunsController extends Controller
{
    ...
    {
        $command = escapeshellcmd('/opt/venv/bin/python /var/www/html/secmon/commands/miniSOM.py');
        shell_exec($command);
    ...
    {
        $command = escapeshellcmd('/opt/venv/bin/python /var/www/html/secmon/commands/anomaly_script.py');
        shell_exec($command);
